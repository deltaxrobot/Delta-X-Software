...
namespace Basler_VideoWriterParams
{
    ...
    //**************************************************************************************************
    // Parameter class CVideoWriterParams_Params_v9_0_0
    //**************************************************************************************************
    ...
    The \c Pylon::CVideoWriter can be used to create video files in the MP4 format. The \ref sample_Utility_GrabVideo code sample shows the use of the Video Writer class.
    */
    class PYLONBASE_API CVideoWriterParams_Params_v9_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CVideoWriterParams_Params_v9_0_0( void );
    ...
    private:
        class CVideoWriterParams_Params_v9_0_0_Data;
        CVideoWriterParams_Params_v9_0_0_Data* m_pCVideoWriterParams_Params_v9_0_0_Data;
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CVideoWriterParams_Params_v9_0_0(CVideoWriterParams_Params_v9_0_0&);

        //! not implemented assignment operator
        CVideoWriterParams_Params_v9_0_0& operator=(CVideoWriterParams_Params_v9_0_0&);
    ...
    //**************************************************************************************************
    // Parameter class CVideoWriterParams_Params_v9_1_0
    //**************************************************************************************************
    ...
    The \c Pylon::CVideoWriter can be used to create video files in the MP4 format. The \ref sample_Utility_GrabVideo code sample shows the use of the Video Writer class.
    */
    class PYLONBASE_API CVideoWriterParams_Params_v9_1_0 : public CVideoWriterParams_Params_v9_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CVideoWriterParams_Params_v9_1_0( void );
    ...
    private:
        class CVideoWriterParams_Params_v9_1_0_Data;
        CVideoWriterParams_Params_v9_1_0_Data* m_pCVideoWriterParams_Params_v9_1_0_Data;
    ...
    The \c Pylon::CVideoWriter can be used to create video files in the MP4 format. The \ref sample_Utility_GrabVideo code sample shows the use of the Video Writer class.
    */
    class CVideoWriterParams_Params : public CVideoWriterParams_Params_v9_1_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CVideoWriterParams_Params_v9_1_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_VideoWriterParams
