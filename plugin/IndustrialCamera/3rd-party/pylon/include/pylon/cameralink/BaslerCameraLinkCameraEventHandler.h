...
#ifndef INCLUDED_BASLERCAMERALINKCAMERAEVENTHANDLER_H_3102315
#define INCLUDED_BASLERCAMERALINKCAMERAEVENTHANDLER_H_3102315
...
namespace Pylon
{
    ...
    /**
    \class  CBaslerCameraLinkCameraEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnCameraEvent( CBaslerCameraLinkInstantCamera& camera, intptr_t userProvidedId, GENAPI_NAMESPACE::INode* pNode )
        {
        }
        ...
        \param[in]  userProvidedId  This ID is passed as a parameter in CBaslerCameraLinkCameraEventHandler::OnCameraEvent and can be used to distinguish between different events.
        ...
        */
        virtual void OnCameraEventHandlerRegistered( CBaslerCameraLinkInstantCamera& camera, const String_t& nodeName, intptr_t userProvidedId )
        {
        }
        ...
        \threading
            This method is called inside the lock of the camera event handler registry.
        */
        virtual void OnCameraEventHandlerDeregistered( CBaslerCameraLinkInstantCamera& camera, const String_t& nodeName, intptr_t userProvidedId )
        {
        }
        ...
        */
        ...
        /// Copy.
        CBaslerCameraLinkCameraEventHandler( const CBaslerCameraLinkCameraEventHandler& )
            : m_eventHandlerRegistrationCount( 0 )
        {
        }

        /// Assign.
        CBaslerCameraLinkCameraEventHandler& operator=( const CBaslerCameraLinkCameraEventHandler& )
        {
            return *this;
        }

        /// Destruct.
        virtual ~CBaslerCameraLinkCameraEventHandler()
        {
...
#endif /* INCLUDED_BASLERCAMERALINKCAMERAEVENTHANDLER_H_3102315 */
