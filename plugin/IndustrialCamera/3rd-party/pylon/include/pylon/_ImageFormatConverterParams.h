...
namespace Basler_ImageFormatConverterParams
{
    ...
    //**************************************************************************************************
    // Parameter class CImageFormatConverterParams_Params_v9_0_0
    //**************************************************************************************************
    ...
    The \ref sample_Utility_ImageFormatConverter code sample shows the use of the Image Format Converter class.
    */
    class PYLONBASE_API CImageFormatConverterParams_Params_v9_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CImageFormatConverterParams_Params_v9_0_0( void );
    ...
    private:
        class CImageFormatConverterParams_Params_v9_0_0_Data;
        CImageFormatConverterParams_Params_v9_0_0_Data* m_pCImageFormatConverterParams_Params_v9_0_0_Data;
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CImageFormatConverterParams_Params_v9_0_0(CImageFormatConverterParams_Params_v9_0_0&);

        //! not implemented assignment operator
        CImageFormatConverterParams_Params_v9_0_0& operator=(CImageFormatConverterParams_Params_v9_0_0&);
    ...
    The \ref sample_Utility_ImageFormatConverter code sample shows the use of the Image Format Converter class.
    */
    class CImageFormatConverterParams_Params : public CImageFormatConverterParams_Params_v9_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CImageFormatConverterParams_Params_v9_0_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_ImageFormatConverterParams
