...
void TextLayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TextLayer *_t = static_cast<TextLayer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (TextLayer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextLayer::click)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TextLayer::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_TextLayer.data,
      qt_meta_data_TextLayer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
