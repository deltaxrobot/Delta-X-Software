...
void TextLayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TextLayer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextLayer::click)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TextLayer::staticMetaObject = { {
    QMetaObject::SuperData::link<QLineEdit::staticMetaObject>(),
    qt_meta_stringdata_TextLayer.data,
    qt_meta_data_TextLayer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
