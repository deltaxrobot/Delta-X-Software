...
public:
    ...
    void setupUi(QDialog *FilterWindow)
    {
        ...
        cbInvert->setObjectName("cbInvert");

        verticalLayout_2->addWidget(cbInvert);

        lbOriginImage = new QLabel(frame1);
        lbOriginImage->setObjectName("lbOriginImage");
        ...
        lbProcessImage->setObjectName("lbProcessImage");
